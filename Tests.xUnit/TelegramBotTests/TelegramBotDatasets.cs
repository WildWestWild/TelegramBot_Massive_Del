...
public class TelegramBotDatasets
{
    ...
    public static IEnumerable<object[]> GetOperationsWithRandomList()
    {
        ...
        yield return new object[] { new TelegramBotDatasets { MessageText = "Добавь элемент", ChartId = 1, ExpectedMessageText = "Введите элемент (чтобы выйти из режима записи в список, нажмите 'Завершить действие'):" } };
    ...
    public static IEnumerable<object[]> GetOperationsWithPreparedList()
    {
        ...
        yield return new object[] { new TelegramBotDatasets { MessageText = "Добавь элемент", ChartId = 2, ExpectedMessageText = "Введите элемент (чтобы выйти из режима записи в список, нажмите 'Завершить действие'):" } };
        ...
        yield return new object[] { new TelegramBotDatasets { MessageText = "Завершить действие", ChartId = 2, ExpectedMessageText = "Действие завершено!" } };
        ...
        yield return new object[] { new TelegramBotDatasets { MessageText = "Вычеркни элемент", ChartId = 2, ExpectedMessageText = "Введите номер элемента: " } };
